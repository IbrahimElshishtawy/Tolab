...
import '../../features/community/ui/community_screen.dart'; // PostDetails is here too
    ...
    ShellRoute(
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) {
            final id = int.parse(state.pathParameters['id']!);
            final task = Task(id: id, title: 'Deep Linked Task', description: 'Description for $id', dueDate: DateTime.now());
        ...
        GoRoute(
          ...
          builder: (context, state) {
            final id = int.parse(state.pathParameters['id']!);
            final quiz = Quiz(id: id, title: 'Deep Linked Quiz', subjectId: 1, startAt: DateTime.now(), endAt: DateTime.now(), duration: 30, totalPoints: 10);
        ...
        GoRoute(
          ...
          builder: (context, state) {
            final id = int.parse(state.pathParameters['id']!);
            final post = {'id': id, 'user': 'User', 'content': 'Deep linked post', 'likes': 0, 'comments_count': 0, 'created_at': DateTime.now().toIso8601String()};
