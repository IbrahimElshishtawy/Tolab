  ...
  routes: [
    ...
    ShellRoute(
      ...
      routes: [
          ...
          routes: [
            GoRoute(
              ...
              routes: [
                ...
                GoRoute(
                  path: 'summaries',
                  builder: (context, state) => SummariesScreen(
                    subjectId: int.parse(state.pathParameters['id']!),
                  ),
                  routes: [
                    GoRoute(
                      path: 'add',
                      builder: (context, state) => AddSummaryScreen(
                        subjectId: int.parse(state.pathParameters['id']!),
                      ),
                    ),
                  ],
        ...
        GoRoute(
          path: '/results',
          builder: (context, state) => const AcademicResultsScreen(),
        ),
        GoRoute(
          path: '/language',
        ...
        GoRoute(
          ...
          builder: (context, state) => const AdminOfferingsScreen(),
        ),
        GoRoute(
          path: '/admin/content',
        ...
        GoRoute(
          ...
          builder: (context, state) =>
              const AdminBroadcastNotificationsScreen(),
        ),
      ],
    ),
  ],
